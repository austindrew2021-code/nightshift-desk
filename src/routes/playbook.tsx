        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          {[
            ...
            },
            {
              ...
              d: "Tap ICT · majors. DAY = previous-day high/low + 50% EQ, WK = week high/low, FIB/OTE = 38.2–78.6 and the 62–79 entry box, GRAB = stop-hunt wicks. Longs only in discount, shorts only in premium, and only after a sweep + CISD — sitting at the level is not a trade. Size is 20×, 50% margin, 1R ~12% (hard cap 18%). Half off at 1R, stop to breakeven, runner to 3R. Leave it through London 2–5, Judas 7–10, Silver Bullet 10–11 or 2–3 NY, and funding hours.",
            },
            {
