...
const ICT = [
  ...
  { t: "Flash crash / liquidity grab", d: "Desks run stops on purpose: a 2.2×ATR wick that closes back inside. Long the reclaim of a low (flash crash), short the reclaim of a high. 15m panic-fade is now a fill, not just a GRAB box — it was the only published method that beat our ICT book on a 30-day walk-forward ($100→$1.6k at 40×/18%, five weeks all green). 5m still needs CISD/FVG. A wick that does not reclaim is not a trade. Combining panic with Silver/AMD/Judas is allowed; stuffing ORB/EMA/RSI on top ruined the book." },
