...
const ICT = [
  ...
  { t: "A+ / range / 20x×50%", d: "A trade needs a liquidity raid, CISD, FVG or Unicorn in premium/discount (OTE 62–79), and ≥1.7R to DOL. Default 40× cap, 50% margin, 1R = 18% (chips 20/40/50× and 12/18/30%). Why 40×: a 0.14% A+ stop at 20× is only a 2.8% 1R — that is why BNB’s 3R runner paid $2.55 on a $100 book. 40× lets tight stops size closer to 18% without taking worse setups. Close 100% at 1R — runners to 5–8R and ¼/½ holds gave back more than they made on the Jul–Sep walk. Extra fills / noPick did not help. Do not size 50% 1R off one green day." },
  ...
  { t: "Scalps", d: "Silver Bullet 10–11 NY: sweep of the 9am hour, or CISD away from a 9am Asia raid. PM Silver Bullet 2–3 NY: sweep of the AM session. PM scalp 1:30–4. Close 100% at 1R." },
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          {[
            ...
            },
            {
              ...
              d: "Tap ICT · majors. DAY = previous-day high/low + 50% EQ, WK = week high/low, FIB/OTE = 38.2–78.6 and the 62–79 entry box, GRAB = stop-hunt wicks. Longs only in discount, shorts only in premium, and only after a sweep + CISD — sitting at the level is not a trade. Size is 40×, 50% margin, 1R 18%. Close 100% at 1R. Leave it through London 2–5, Judas 7–10, Silver Bullet 10–11 or 2–3 NY, and funding hours.",
            },
            {
