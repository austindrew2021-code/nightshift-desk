...
const ICT = [
  ...
  { t: "Flash crash / liquidity grab", d: "Desks run stops on purpose: a 2.2×ATR wick that closes back inside. Long the reclaim of a low (flash crash), short the reclaim of a high. 15m panic-fade is a fill. 5m now also takes the 2022 model: SSL/BSL or PDH/PDL raid → CISD displacement → FVG in the killzone. That 5m CISD+FVG book was +0.34R / 78% on the last ~2 weeks of tape and stacked with 15m without flipping a week red. A wick that does not reclaim, or a CISD with no FVG/OB, is not a trade." },
