...
const ICT = [
  ...
  { t: "A+ / range / 20x×50%", d: "A trade needs a liquidity raid, CISD, FVG or Unicorn in premium/discount (OTE 62–79), and ≥1.7R to DOL. Default 40× cap, 50% margin, 1R = 18% (chips 20/40/50× and 12/18/30%). Why 40×: a 0.14% A+ stop at 20× is only a 2.8% 1R — that is why BNB’s 3R runner paid $2.55 on a $100 book. 40× lets tight stops size closer to 18% without taking worse setups. Three-quarters off at 1R, ¼ runner ratchet BE → 5R. 30-day walk-forward (13 Aug–12 Sep): session ratchet 20×/18% $100→$224 (one week did $100→$231 at 94% win; two weeks were flat/red). Same trades at 40× → $374. 30% 1R → $239. Keeping 75% on the runner → $148 (locking ¾ at 1R is the edge). Extra fills / noPick / 8R targets did not help. Do not size 50% 1R off one green day." },
  ...
  { t: "Scalps", d: "Silver Bullet 10–11 NY: sweep of the 9am hour, or CISD away from a 9am Asia raid. PM Silver Bullet 2–3 NY: sweep of the AM session. PM scalp 1:30–4. Three-quarters off at 1R, ¼ runner to 2–3R." },
  { t: "Fibonacci / OTE", d: "Every dealing range (previous-day high/low and the displacement after a raid) is measured with 38.2 / 50 / 61.8 / 70.5 / 78.6. Optimal Trade Entry is the 62–79% retrace — 70.5 is the sweet spot. Longs buy the discount OTE of an up-impulse; shorts sell the premium OTE of a down-impulse. If the FVG sits inside that OTE, the fill is graded A+ and the entry is the 70.5, not mid-range." },
  { t: "Flash crash / liquidity grab", d: "Desks run stops on purpose: a 2.2×ATR wick that closes back inside. Long the reclaim of a low (flash crash), short the reclaim of a high. 15m panic-fade is a fill. 5m takes the 2022 model: SSL/BSL or PDH/PDL raid → CISD displacement → FVG in the killzone. Skip any fill whose stop is under 0.8% — KuCoin taker turns those into fee. Wait-one-bar and pin/soup extras missed the reversal; the CISD close *is* the tell. A wick that does not reclaim, or a CISD with no FVG/OB, is not a trade." },
  { t: "Regime switch", d: "1H ATR vs its 50-bar ATR is shown on the desk: expand (≥1.35×, stays on until 1.18×) vs chop/trend. A+ CISD (Judas / Silver / AMD / sweep / Asia / daily / 5m CISD) still fills in chop — that is the SOL +1R scalp. Weak OB/FVG/div does not. When expand dies, lock 50% of free cash into the vault and snap open stops to break-even. During expand, drip 25% of each +$200. Pools (PDH/PDL, Asia H/L) mark WHERE; CISD close is WHEN. Chart: ASIA / DAY / GRAB." },
  { t: "40× isolated liq", d: "Isolated liquidation is marked: 1/leverage − 0.5% maintenance. At 40× that is ~2.0%. The working SL cannot sit past that price — a wider ICT wick stop is capped to liq and 1R is sized to that distance. Chart: LIQ line when it is farther than SL. Tape: LIQ 2.0% SL inside, or LIQ cap. Last month 98% of 15m+5m stops were already inside 2%; 0 liquidations. A gap through 2% is still a real-account wipe this OHLC book cannot see." },
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          {[
            ...
            },
            {
              ...
              d: "Tap ICT · majors. DAY = previous-day high/low + 50% EQ, WK = week high/low, FIB/OTE = 38.2–78.6 and the 62–79 entry box, GRAB = stop-hunt wicks. Longs only in discount, shorts only in premium, and only after a sweep + CISD — sitting at the level is not a trade. Size is 40×, 50% margin, 1R 18%. Three-quarters off at 1R, stop to breakeven, ¼ runner to 5R. Leave it through London 2–5, Judas 7–10, Silver Bullet 10–11 or 2–3 NY, and funding hours.",
            },
            {
