...
const KEY = "nightshift.engine.v4";
...
export function loadEngine(): EngineState | null {
  ...
  try {
    ...
    const restored: EngineState = {
      ...
      ictStyle: e.ictStyle === "sweep" || e.ictStyle === "scalp" || e.ictStyle === "swing" || e.ictStyle === "all" || e.ictStyle === "cisd" ? e.ictStyle : "cisd",
      ...
      ictChopLocked: Boolean(e.ictChopLocked),
